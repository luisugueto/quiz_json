...
var create_label = function create_label(name) {
...
exports.deleted_Questions = undefined;

var _create_label = __webpack_require__(89);

var _create_label2 = _interopRequireDefault(_create_label);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var deleted_Questions = exports.deleted_Questions = '';

window.add_question = function () {
    var questions = document.getElementById('questions'),
        countQuestions = document.querySelector('input[name="countQuestions"]');
    var divQuestion = document.createElement("div"),
        divAnswer = document.createElement("div"),
        divButton = document.createElement("div");
    var labelQuestion = (0, _create_label2.default)('Question'),
        labelAnswer = (0, _create_label2.default)('Answer'),
        labelAnswerCorrect = (0, _create_label2.default)('Correct');
    var inputQuestion = document.createElement("input"),
        inputAnswer = document.createElement("input"),
        inputCountAnswer = document.createElement("input");
    var radioAnswer = document.createElement("input"),
        buttonAnswer = document.createElement("button"),
        buttonDelete = document.createElement("button"),
        br = document.createElement("br");;
    var contador = parseInt(countQuestions.value);
...
window.deleteQuestion = function (number) {
    var element = document.getElementById("question" + number);
    var button = document.getElementById("button_question" + number);
    element.parentNode.removeChild(element);
    button.parentNode.removeChild(button);

    if (deleted_Questions == '') {
        exports.deleted_Questions = deleted_Questions += number;
    } else {
        exports.deleted_Questions = deleted_Questions += "," + number;
    }
...
var _answer = __webpack_require__(330);

var _badges = __webpack_require__(331);

var _badges2 = _interopRequireDefault(_badges);

var _questions = __webpack_require__(125);

var question = _interopRequireWildcard(_questions);
...
var getJson = exports.getJson = function getJson() {
    ...
    var results = document.querySelector('input[name="results"]').value,
        slug = document.querySelector('input[name="slug"]').value;
    var category = document.querySelector('input[name="category"]').value;
    var countBadges = document.querySelector('input[name="countBadges"]'),
        countQuestions = document.querySelector('input[name="countQuestions"]');
    var json = {};
    ...
    for (var i = 1; i <= inputsPoint.length; i++) {
        var structJson = {};
    ...
    for (var _i = 0; _i <= countQuestions.value; _i++) {

        if (_questions.deleted_Questions.indexOf(_i) < 0) {
            var questions = document.querySelector('input[name="question' + _i + '"]');
            var _countQuestions = document.querySelector('input[name="countAnswerQuestion' + _i + '"]');

            var correct_answer = void 0;
            var _structJson = {};
            _structJson.q = questions.value;
            _structJson.a = [];
            for (var j = 0; j <= _countQuestions.value; j++) {
                var correct = document.getElementsByName("correct" + _i);
                if (correct[j].checked) correct_answer = j;
            }

            for (var _j = 0; _j <= _countQuestions.value; _j++) {
                var answer = document.querySelector('input[name="answer' + _j + '-Question' + _i + '"]');
                var deleteQuestions = document.getElementById("deleteQuestions"),
                    answerJson = {};

                answerJson.option = answer.value;

                if (_j == correct_answer) answerJson.correct = true;else answerJson.correct = false;
                _structJson.a.push(answerJson);
            }
            json.info.questions.push(_structJson);
        }
    }
...
window.add_answer = function (number) {
    var answers = document.getElementById('answer' + number),
        countAnswers = document.querySelector('input[name="countAnswerQuestion' + number + '"]'),
        contador = parseInt(countAnswers.value);
    var divAnswer = document.createElement("div");
    var divQuestion = document.getElementById('question' + number);
    var labelAnswer = (0, _create_label2.default)('Answer'),
        labelAnswerCorrect = (0, _create_label2.default)('Correct');
    var inputAnswer = document.createElement("input"),
        radioAnswer = document.createElement("input");
...
window.add_badges = function () {
    var badges = document.getElementById('badges'),
        countBadges = document.querySelector('input[name="countBadges"]');
    var divSlug = document.createElement("div"),
        divPoints = document.createElement("div");
    var labelSlug = (0, _create_label2.default)('Slug'),
        labelPoints = (0, _create_label2.default)('Points');
    var inputSlug = document.createElement("input"),
        inputPoints = document.createElement("input"),
        inputBadges = document.createElement("input");
    var contador = parseInt(countBadges.value);
